...
public class PO_NavView extends PO_View {
	...
	public static void clickOnlyOption(WebDriver driver, String textOption) {
		// CLickamos en la opción de registro y esperamos a que se cargue el enlace de
		// Registro.
		...
		// Ahora lo clickamos
		elementos.get(0).click();
		SeleniumUtils.esperarSegundos(driver, getTimeout());
	 ...
	 * 
	 */
	public static void selectDropdownMenuOption(WebDriver driver, String dropdownmenuid, String dropdownmenuListid, String optionid) {

		List<WebElement> elementos = SeleniumUtils.EsperaCargaPagina(driver, "id", dropdownmenuid, getTimeout());
		elementos.get(0).click();

		elementos = SeleniumUtils.EsperaCargaPagina(driver, "id", dropdownmenuListid, getTimeout());
